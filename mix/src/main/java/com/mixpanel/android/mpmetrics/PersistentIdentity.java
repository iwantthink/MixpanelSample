...
@SuppressLint("CommitPrefEdits")
    ...
    /**
     * 获取[com.mixpanel.android.mpmetrics.MixpanelAPI.TimeEvents_] SP
     * 将其中的内容组装成一个Map 返回
     *
     * @return
     */
    ...
    private void readIdentities() {
        ...
        //从 sp中读取 distinctID 和waiting_array
    ...
    /**
     * 将eventDistinctID 和peopleDistinctID 写入到SP中
     * 如果 waiting_array 存在,则写入, 不存在则移除key
     * <p>
     * All access should be synchronized on this
     */
     ...
     * 是否加载过 identities
     * <p>
     * 在调用过readIdentities()方法之后,会被置为true
     */

...
import com.datatist.android_plugin.AJXConfig
import com.datatist.android_plugin.AJXExtension
import com.datatist.android_plugin.internal.cache.AJXCache
...
class AJXProcedure extends AbsProcedure {
    ...
    AJXProcedure(Project proj) {
        ...
        project.afterEvaluate {
            ...
            AJXExtension ajxExtension = project.DatatistTrack

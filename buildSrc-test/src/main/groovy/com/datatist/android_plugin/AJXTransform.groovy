 ...
 */
package com.datatist.android_plugin
...
import com.datatist.android_plugin.internal.cache.VariantCache
import com.datatist.android_plugin.internal.procedure.AJXProcedure
import com.datatist.android_plugin.internal.procedure.CacheAspectFilesProcedure
import com.datatist.android_plugin.internal.procedure.CacheInputFilesProcedure
import com.datatist.android_plugin.internal.procedure.CheckAspectJXEnableProcedure
import com.datatist.android_plugin.internal.procedure.DoAspectWorkProcedure
import com.datatist.android_plugin.internal.procedure.OnFinishedProcedure
import com.datatist.android_plugin.internal.procedure.UpdateAspectFilesProcedure
import com.datatist.android_plugin.internal.procedure.UpdateAspectOutputProcedure
import com.datatist.android_plugin.internal.procedure.UpdateInputFilesProcedure
...
class AJXTransform extends Transform {
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        ajxProcedure.with(new CheckAspectJXEnableProcedure(
                project, variantCache, transformInvocation))
